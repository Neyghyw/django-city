...
class ShopsListView(generics.ListCreateAPIView):
    ...
    def create(self, request, *args, **kwargs):
        ...
        item = Shop.objects.create(
            ...
            shop_city_id=City.objects.filter(city_name=(serializer.data['shop_city_id']['city_name'])).first(),
            shop_street_id=Street.objects.filter(street_name=(serializer.data['shop_street_id']['street_name'])).first(),
